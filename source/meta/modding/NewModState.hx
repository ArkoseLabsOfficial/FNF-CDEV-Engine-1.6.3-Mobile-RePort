	...
	override function update(elapsed:Float)
	{
		...
		if (butt_createMod != null && FlxG.mouse.overlaps(butt_createMod))
		{
			...
			if (FlxG.mouse.justPressed)
			{
				...
				var modExists:Bool = FileSystem.exists(#if mobile StorageUtil.getExternalStorageDirectory() + #end Paths.modsPath + "/" + modNameTrimmed) && FileSystem.isDirectory(#if mobile StorageUtil.getExternalStorageDirectory() + #end Paths.modsPath + "/" + modNameTrimmed);
